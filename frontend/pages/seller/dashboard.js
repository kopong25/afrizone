...
export default function SellerDashboard() {
  ...
  const { supported: pushSupported, subscribed: pushSubscribed, loading: pushLoading, error: pushError, permission, subscribe: enablePush, unsubscribe: disablePush } = usePushNotifications();
