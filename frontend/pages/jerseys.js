...
const AFRICAN_TEAMS = [
  ...
  { country: "Morocco", flag: "🇲🇦", nickname: "Atlas Lions", kit_maker: "Puma", accent: "#C1272D", bg: "from-[#C1272D] to-[#7a0000]", image: "https://res.cloudinary.com/dta7pubd5/image/upload/v1775687811/MOROCONT_os3byk.jpg", price: "$89.99", description: "Qatar 2022 semi-finalists. Africa's pride.", hot: true, affiliateUrl: "https://fanatics.93n6tx.net/morocco" },
  { country: "Senegal", flag: "🇸🇳", nickname: "Lions of Teranga", kit_maker: "Puma", accent: "#FDEF42", bg: "from-[#00853F] to-[#004d24]", image: "https://res.cloudinary.com/dta7pubd5/image/upload/v1775687811/SENEGALnt_mhqdtt.jpg", price: "$89.99", description: "AFCON Champions. Mane's nation.", hot: true, affiliateUrl: "https://fanatics.93n6tx.net/SENEGAL" },
  { country: "Egypt", flag: "🇪🇬", nickname: "Pharaohs", kit_maker: "Adidas", accent: "#CE1126", bg: "from-[#CE1126] to-[#800000]", image: "https://res.cloudinary.com/dta7pubd5/image/upload/v1775687810/EgyptNT_wyllfx.jpg", price: "$84.99", description: "Salah leads the Pharaohs. 7x AFCON winners.", hot: true, affiliateUrl: "https://fanatics.93n6tx.net/EGYPTNT" },
  { country: "Algeria", flag: "🇩🇿", nickname: "Desert Foxes", kit_maker: "Adidas", accent: "#006233", bg: "from-[#006233] to-[#003d1f]", image: "https://res.cloudinary.com/dta7pubd5/image/upload/v1775687810/algeriant_pwcgnd.jpg", price: "$84.99", description: "AFCON 2019 Champions. Iconic white.", hot: false, affiliateUrl: "https://fanatics.93n6tx.net/ALGERIA" },
  { country: "Cote d'Ivoire", flag: "🇨🇮", nickname: "The Elephants", kit_maker: "Nike", accent: "#F77F00", bg: "from-[#F77F00] to-[#b35a00]", image: "https://res.cloudinary.com/dta7pubd5/image/upload/v1775687810/IVORYCOASTNT_kffbuh.jpg", price: "$89.99", description: "AFCON 2024 Champions. Unstoppable.", hot: true, affiliateUrl: "https://fanatics.93n6tx.net/CD" },
  { country: "South Africa", flag: "🇿🇦", nickname: "Bafana Bafana", kit_maker: "Adidas", accent: "#FFB612", bg: "from-[#007A4D] to-[#004d30]", image: "https://res.cloudinary.com/dta7pubd5/image/upload/v1775687812/southafricaNT_qnxtcp.jpg", price: "$84.99", description: "The Rainbow Nation returns to the world stage.", hot: false, affiliateUrl: "https://fanatics.93n6tx.net/SOUTHAFRICA" },
                    ...
                    <div className="p-4 flex flex-col flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400">{s.club}</p>
                        </div>
                      </div>
                  ...
                  {filteredWorld.map(t=>(
                    <a key={t.country} href={t.affiliateUrl || FANATICS_URL} target="_blank" rel="noopener noreferrer"
                      ...
                      <div className="min-w-0">
                        <p className="font-bold text-white text-sm truncate group-hover:text-yellow-400 transition-colors">{t.country}</p>
                        <p className="text-xs text-gray-500">{t.price}</p>
                        {t.hot && <span className="text-xs text-red-400">HOT</span>}
                      </div>
                    </a>
                  ))}
                </div>
