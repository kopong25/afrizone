      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">
              {featuredCount}/4 slots used · Carousel auto-advances every 5 seconds
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 text-gray-400">
            ...
            <p className="text-sm">Create your first ad to show in the homepage carousel</p>
          </div>
        ) : (
          <div className="space-y-3">
            {ads.map((ad) => (
              ...
              <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Or paste a URL below. Uploaded images are stored on Cloudinary.
                  </p>
                  <input
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      <label className="text-xs text-gray-400 block mb-1">Button / accent color</label>
                      <div className="flex items-center gap-2 border rounded-lg px-2 py-1">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <label className="text-sm text-gray-600">Sort order (0 = first in carousel)</label>
                </div>
